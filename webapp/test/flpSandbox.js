		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Empreendimentos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Empreendimentos-display": {
								"semanticObject": "Empreendimentos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.itsgroup.brz.enterprises",
									"url": sap.ui.require.toUrl("com/itsgroup/brz/enterprises")
								}
							}
						}
					}
